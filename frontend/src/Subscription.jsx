                ...
                <div className="col-xl-9 col-12 main-content-wrapper">
                        ...
                        <div className="preorder-block-wrap">
                            ...
                            <div className={"table-responsive"}>
                                <table className="table">
                                    <thead>
                                    <tr>
                                        <th className="title_table" scope="col">Loại báo</th>
                                        <th className="title_table" scope="col">Giá</th>
                                        <th className="title_table" scope="col">Số kì</th>
                                        <th className="title_table" scope="col">Số lượng/kỳ</th>
                                        <th className="title_table" scope="col">Khuyến mãi</th>
                                        <th className="title_table" scope="col">Thành tiền</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <div className={"table-responsive"}>
                                <table className="table">
                                    <thead>
                                    <tr>
                                        <th className="title_table thoi_gian" scope="col">Thời gian</th>
                                        <th className="title_table" scope="col">Giá</th>
                                        <th className="title_table" scope="col">Số lượng</th>
                                        <th className="title_table" scope="col">Khuyến mãi</th>
                                        <th className="title_table" scope="col">Tổng</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                    ...
                    <div className="summary_section mt_4">
                        ...
                        <div className="button_container">
                            <button className="btn_submit_final">
                                ĐẶT BÁO <span className="arrow_icon">→</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="company_info">
                        <p className="font_merriweather mb_1" style={{fontSize: '18px', fontWeight: '900'}}>
                            Chi tiết quý bạn đọc vui lòng liên hệ
                        </p>
                        <p className="color_theme font_merriweather" style={{fontWeight: '900'}}>
                            Tại TP.HCM nhận giao tại các phường, xã:
                        </p>

                        {/* Khối TP.HCM nổi bật */}
                        <div className="addr_item">
                            <div className="title">Bộ phận Phát hành - Trung tâm dịch vụ truyền thông Báo Thanh Niên
                            </div>
                            <div className="item">
                    ...
                    <div className="sticky_sidebar">
                        <div className="sidebar_container p-3">
                            ...
                            <div className="d-flex justify-content-between mb-3 mt-3">
                                <span style={{fontSize: '13px', fontWeight: 'bold', color: '#4396CC'}}>Tổng thanh toán</span>
                                <span style={{
                                    fontSize: '14px',
                                    fontWeight: 'bold',
                                    color: '#4396CC'
                            ...
                            <button className="btn_submit_final w-100">ĐẶT BÁO →</button>
                            <hr/>
